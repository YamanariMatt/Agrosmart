...
const apiKey = ba04a400a8c4b6de9126a356942919a7
; // Insira sua chave da API OpenWeatherMap.

async function fetchWeatherData() {
const city = navigator.geolocation; // Substitua pelo nome da cidade ou permita o usuário selecionar.
